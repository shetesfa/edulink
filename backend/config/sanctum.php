<?php
$userDomains = explode(',', env('SANCTUM_STATEFUL_DOMAINS', ''));
$defaultDomains = ['localhost', 'localhost:3000', 'localhost:5173', '127.0.0.1', '127.0.0.1:8000', '::1', 'edulink-blond.vercel.app'];

return [
    'stateful' => array_merge($defaultDomains, $userDomains),
    'guard'    => ['web'],
    'expiration' => null,
