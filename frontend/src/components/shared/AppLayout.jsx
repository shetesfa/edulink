...
const navItems = [
  { to: '/dashboard', icon: LayoutDashboard, label: 'Dashboard',    roles: ['student', 'teacher'] },
  { to: '/classes',   icon: BookOpen,        label: 'My Classes',   roles: ['student', 'teacher'] },
  { to: '/chat',      icon: MessageSquare,   label: 'Messages',     roles: ['student', 'teacher'] },
  { to: '/ai',        icon: Bot,             label: 'AI Assistant', roles: ['student', 'teacher'] },
];
  ...
  const Sidebar = ({ mobile = false }) => (
    <div className={clsx(
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
        <div className="w-9 h-9 bg-brand-gradient rounded-xl flex items-center justify-center font-black text-lg font-display">
          <span className="text-white">E</span>
        </div>
        <span className="font-display font-bold text-xl">Edu<span className="text-amber-300">Link</span></span>
        {mobile && (
