          ...
          <div className="flex items-end justify-between -mt-10 sm:-mt-14 mb-4">
            ...
            <div className="relative group cursor-pointer" onClick={() => isOwn && avatarRef.current?.click()}>
              {profile.profile_photo ? (
                ...
                <div className="w-20 h-20 sm:w-28 sm:h-28 rounded-2xl border-4 border-white dark:border-gray-800 shadow-lg bg-brand-gradient flex items-center justify-center font-display font-bold text-3xl text-white">
              ...
              <div className="flex items-center gap-2 flex-wrap justify-between">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className={clsx('text-xs font-semibold px-2 py-0.5 rounded-full capitalize',
                    profile.role==='teacher'?'bg-amber-100 text-amber-800':'bg-sky-100 text-sky-800')}>
                    {profile.role?.replace('_',' ')}
                  </span>
                </div>
                {!isOwn && (
                  <Link to={`/chat/private/${profile.id}`} className="flex items-center gap-2 px-4 py-2 bg-brand-600 hover:bg-brand-700 text-white rounded-xl text-sm font-semibold transition-all shadow-sm">
